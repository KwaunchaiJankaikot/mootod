<template>
  <div class="home-container">
    <!-- แทนที่ header เดิมด้วย HeaderNavbar -->
    <HeaderNavbar :cartItems="cartItems" @toggle-cart="toggleCart" />
    ...
    <div class="menu-cards">
      ...
      <div class="menu-card view-all-card" @click="viewAllMenus">
        <div class="card-content view-all-content">
...
/* ลบส่วน header CSS ออกเนื่องจากเราใช้ HeaderNavbar component แล้ว */
