...
@media (max-width: 480px) {
  ...
  .card-image img {
  width: 100%;         /* ให้ภาพกว้างเต็มการ์ด */
  height: 200px;       /* กำหนดความสูงที่แน่นอนให้กับภาพ */
  object-fit: cover;   /* ให้ภาพเต็มพื้นที่ของการ์ดโดยไม่บิดเบี้ยว */
  border-radius: 8px;  /* ใส่ขอบมนให้กับภาพ */
}
