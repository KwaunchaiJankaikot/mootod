      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
        ...
        >
          ...
          <div class="p-4">
            ...
            <p class="text-gray-600 text-sm mb-4">{{ truncateDescription(menu.description) }}</p>
      ...
      <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6 mx-4">
        <div class="mb-4">
          ...
          <p class="text-gray-600 text-center">
            คุณต้องการลบเมนู <span class="font-semibold">{{ menuToDelete ? menuToDelete.name : '' }}</span> ใช่หรือไม่? 
